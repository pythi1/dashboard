...
export default function table() {
  ...
  return (
    <div className='min-h-screen m-10 mt-15 max-w-screen' >
      <div className='mt-5 ' >
        <h1 className='text-4xl font-semibold mb-2' >Table</h1>
        <p> <Link href='/dashboard' className='text-blue-500 underline cursor-pointer' >Dashboard</Link> <span className='text-gray-500' >/ tables</span> </p>
      </div>

      <div className='mt-5 mb-5 p-4 border rounded-lg ' >
      ...
      <div className='border border-gray-300 rounded-lg'>
        ...
        <div className='flex justify-between items-center' >
          <div className='flex items-center'>
            <select className='border rounded-lg border-gray-300 outline-none m-3 h-10 w-20 ' >
          ...
          <input
            placeholder='Search...'
            className='p-2 h-10 m-5 outline-none border border-gray-300 rounded-lg'
          />
        </div>
        ...
        <div>
        <div>
          <div className=' flex justify-between items-center text-lg flex-auto gap-2 p-2 m-4 ' >

            <span> Showing 1 to 10 of 50 entries</span>

            <span className='borde border-gray-400' > 
              {
                button.map((b) => (
                  <button className='border-r border-gray-400 p-2 h-10 w-7 items-center' key={b} >{b}</button>
                ))
              }
            </span>
